...
const DEFAULT_MESSAGE =
  "Halo SentulTrip, saya ingin tanya informasi paket wisata yang tersedia. Bisa bantu?";
    ...
    >
      ...
      <div className={`floating-wa-tooltip ${showTooltip ? "is-visible" : ""}`}>
        <div className="floating-wa-tooltip-header">
          <span className="floating-wa-status-dot" />
          <span>SentulTrip CS</span>
        </div>
        <p className="floating-wa-tooltip-text">Butuh bantuan? Chat kami via WhatsApp!</p>
      </div>
      ...
      >
        ...
        <span className="floating-wa-badge" aria-hidden="true">
          <span className="floating-wa-badge-inner" />
        </span>
      </a>
    </div>
  );
