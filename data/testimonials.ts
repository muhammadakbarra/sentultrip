...
const testimonials: Testimonial[] = [
  { name: "Tata", trip: "Curug Bidadari · Korporat", initials: "TA", text: "Perusahaan kami gunakan untuk team building. Trekkingnya seru, semua peserta antusias. Guide-nya sabar banget ngurus orang banyak!" },
  ...
  { name: "Mala", trip: "Curug Cibingbin · Korporat", initials: "MA", text: "Selain menemani rombongan, mereka juga ahli ambil foto ciamik karena paham betul medannya. Grup besar atau kecil, recommended!" },
];
